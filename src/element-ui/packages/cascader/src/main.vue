...
import {
  generateId, escapeRegexpString, isIE, isEdge,
...
export default {
  ...
  methods: {
    ...
    handleInputChange(value) {
      ...
      let filteredFlatOptions = flatOptions.filter(optionsStack => optionsStack.some(option => new RegExp(escapeRegexpString(value), 'i')
