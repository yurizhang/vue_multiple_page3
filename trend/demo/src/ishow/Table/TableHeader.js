...
export default class TableHeader extends Component{
  ...
  //这个函数用来渲染th的title，是‘赵斐昊’加的，有问题可以直接叫我改 :D
  renderTitle(column){
    if (Object.prototype.toString.call(column.label) === "[object String]") {
      return column.label
    }
  }
            ...
            <tr key={rowIndex}>
              {columns.map((column, cellIndex) => (
                <th
                  ...
                  key={cellIndex}
                  title = {this.renderTitle(column)}//后加的title，有问题记得回来看这里
                >
                  <div className="cell">
                    ...
                    {column.filterable && (
                      ...
                      >
                        ...
                        >
                          <i className={this.classNames('ishow-icon-arrow-down', { 'ishow-icon-arrow-up': column.filterOpened })} />
                        </span>
                      </FilterPannel>
                    )}
                  </div>
