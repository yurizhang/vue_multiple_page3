  ...
  render() {
    ...
    const menus = activeOptions.map((menu, menuIndex) => {
      ...
      const items = menu.map((item, index) => {
        ...
        return (
          <li key={index} className={this.classNames({
              'ishow-cascader-menu__item': true,
              'ishow-cascader-menu__item--extensible': item.children,
      ...
      return (
        <ul key={menuIndex} className={this.classNames({
          'ishow-cascader-menu': true,
          'ishow-cascader-menu--flexible': isFlat
        })} style={menuStyle}>
          {items}
        </ul>
      );
    ...
    return (
      <Transition name="ishow-zoom-in-top">
        <View show={visible}>
          <div className={this.classNames('ishow-cascader-menus', popperClass)}>
            {menus}
          </div>
        </View>
      </Transition>
