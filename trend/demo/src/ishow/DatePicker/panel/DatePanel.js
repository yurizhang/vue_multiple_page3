  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div className="ishow-picker-panel__body-wrapper">
          {
            Array.isArray(shortcuts) && (
              <div className="ishow-picker-panel__sidebar">
                {
                  shortcuts.map((e, idx) => {
                    return (
                      <button
          ...
          <div className="ishow-picker-panel__body">
            {
              isShowTime && (
                <div className="ishow-date-picker__time-header">
                  <span className="ishow-date-picker__editor-wrap">
                    <Input
            ...
            {
              currentView !== 'time' && (
                <div className="ishow-date-picker__header">
                  <button
                    type="button"
                  ...
                  <span
                    ...
                    className="ishow-date-picker__header-label">{this.yearLabel()}</span>
                  {
                    currentView === PICKER_VIEWS.DATE && (
                      <span
                        onClick={this.showMonthPicker.bind(this)}
                        className={
                          this.classNames('ishow-date-picker__header-label', {
                            active: currentView === 'month'
                          })
                        }
                      >{t(`ishow.datepicker.month${month + 1}`)}</span>
                    )
                  }
                  <button
                    type="button"
            ...
            <div className="ishow-picker-panel__content">
              {this._pickerContent()}
            </div>
          </div>
        </div>

        {
          isShowTime && currentView === PICKER_VIEWS.DATE && (
            <div  className="ishow-picker-panel__footer">
              <a href="javascript:;"
                className="ishow-picker-panel__link-btn"
                onClick={this.changeToNow.bind(this)}>现在</a>
              <button
                type="button"
