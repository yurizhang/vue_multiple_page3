...
export default class Checkbox extends Component {
  ...
  render(){
    return (
      <label style={this.style()} className={this.className('ishow-checkbox')}>
        <span className={this.classNames('ishow-checkbox__input', {
          'is-disabled': this.props.disabled,
          'is-checked': this.state.checked,
          'is-indeterminate': this.props.indeterminate,
          'is-focus': this.state.focus
        })}>
          <span className="ishow-checkbox__inner"></span>
          <input
        ...
        <span className="ishow-checkbox__label" title={this.props.children || this.state.label}>
